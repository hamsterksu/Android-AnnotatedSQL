...
class GroundyLibrary extends AptLibrary  {

    public GroundyLibrary() {
        processors = ["com.telly.groundy.GroundyCodeGen"];

        groupId = 'com.telly'
        artifactIdApt = 'groundy-compiler'
        artifactIdLibrary = 'groundy'
    }
